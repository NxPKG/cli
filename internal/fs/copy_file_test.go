...
func TestCopyFile(t *testing.T) {
	srcTmpDir := nxpkgpath.AbsoluteSystemPath(t.TempDir())
	destTmpDir := nxpkgpath.AbsoluteSystemPath(t.TempDir())
	...
	symlinkSrcDir := nxpkgpath.AbsoluteSystemPath(t.TempDir())
	symlinkTargetDir := nxpkgpath.AbsoluteSystemPath(t.TempDir())
	symlinkDestDir := nxpkgpath.AbsoluteSystemPath(t.TempDir())
...
func TestCopyOrLinkFileWithPerms(t *testing.T) {
	...
	srcDir := nxpkgpath.AbsoluteSystemPath(t.TempDir())
	dstDir := nxpkgpath.AbsoluteSystemPath(t.TempDir())
