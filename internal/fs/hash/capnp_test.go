...
func Test_CapnpHash(t *testing.T) {
	taskHashable := TaskHashable{
		...
		PackageDir:           nxpkgpath.AnchoredUnixPath("package_dir"),
		...
		EnvMode:         util.Loose,
		DotEnv:          []nxpkgpath.AnchoredUnixPath{"dotenv"},
	}
...
func Test_CapnpHashGlobal(t *testing.T) {
	globalHashable := GlobalHashable{
		...
		GlobalFileHashMap: map[nxpkgpath.AnchoredUnixPath]string{
			nxpkgpath.AnchoredUnixPath("global_file_hash_map"): "global_file_hash_map",
		},
...
func Test_CapnpFileHashes_Empty(t *testing.T) {
	fileHashes := map[nxpkgpath.AnchoredUnixPath]string{}
...
func Test_CapnpFileHashes_NonEmpty(t *testing.T) {
	fileHashes := map[nxpkgpath.AnchoredUnixPath]string{
		nxpkgpath.AnchoredUnixPath("a"): "b",
		nxpkgpath.AnchoredUnixPath("c"): "d",
	}
