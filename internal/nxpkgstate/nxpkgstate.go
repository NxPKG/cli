// Package nxpkgstate holds all of the state given from the Rust CLI
// that is necessary to execute nxpkg. We transfer this state from Rust
...
// ExecutionState is the entire state of a nxpkg execution that is passed from the Rust shim.
