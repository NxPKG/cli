...
func FileInfoHeader(fullPath nxpkgpath.AnchoredUnixPath, fileInfo fs.FileInfo, link string) (*tar.Header, error) {
...
func canonicalTarName(fullPath nxpkgpath.AnchoredUnixPath, isDir bool) string {
