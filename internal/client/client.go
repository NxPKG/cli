...
func NewClient(config nxpkgstate.APIClientConfig, logger hclog.Logger, nxpkgVersion string) *APIClient {
	client := &APIClient{
...
func (c *APIClient) userAgent() string {
	return fmt.Sprintf("nxpkg %v %v %v (%v)", c.nxpkgVersion, runtime.Version(), runtime.GOOS, runtime.GOARCH)
}
