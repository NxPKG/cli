...
import (
	...
	"github.com/nxpkg/cli/internal/util/browser"
)
...
func New(repoRoot nxpkgpath.AbsoluteSystemPath, ui cli.Ui, TaskGraph *dag.AcyclicGraph) *GraphVisualizer {
