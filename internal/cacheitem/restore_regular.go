...
func restoreRegular(dirCache *cachedDirTree, anchor nxpkgpath.AbsoluteSystemPath, header *tar.Header, reader *tar.Reader) (nxpkgpath.AnchoredSystemPath, error) {
...
func safeMkdirFile(dirCache *cachedDirTree, anchor nxpkgpath.AbsoluteSystemPath, processedName nxpkgpath.AnchoredSystemPath, mode int64) error {
