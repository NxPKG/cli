...
import (
	...
	"github.com/nxpkg/cli/internal/tarpatch"
	"github.com/nxpkg/cli/internal/nxpkgpath"
)

// Create makes a new CacheItem at the specified path.
func Create(path nxpkgpath.AbsoluteSystemPath) (*CacheItem, error) {
...
func (ci *CacheItem) AddFile(fsAnchor nxpkgpath.AbsoluteSystemPath, filePath nxpkgpath.AnchoredSystemPath) error {
