...
import (
	...
	"github.com/nxpkg/cli/internal/filewatcher"
...
func New(logger hclog.Logger, repoRoot nxpkgpath.AbsoluteSystemPath, cookieWaiter filewatcher.CookieWaiter) *GlobWatcher {
	return &GlobWatcher{
		logger:       logger,
		repoRoot:     repoRoot,
