...
type PackageManager struct {
	...
	// Detect if Nxpkg knows how to produce a pruned workspace for the project
	canPrune func(cwd nxpkgpath.AbsoluteSystemPath) (bool, error)

	// Gets lockfile name.
	GetLockfileName func(projectDirectory nxpkgpath.AbsoluteSystemPath) string
...
func (pm PackageManager) GetWorkspaces(rootpath nxpkgpath.AbsoluteSystemPath) ([]string, error) {
...
func (pm PackageManager) GetWorkspaceIgnores(rootpath nxpkgpath.AbsoluteSystemPath) ([]string, error) {
	return pm.getWorkspaceIgnores(pm, rootpath)
}

// ReadLockfile will read the applicable lockfile into memory
func (pm PackageManager) ReadLockfile(projectDirectory nxpkgpath.AbsoluteSystemPath, rootPackageJSON *fs.PackageJSON) (lockfile.Lockfile, error) {
