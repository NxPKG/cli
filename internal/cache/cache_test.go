...
type testCache struct {
	...
	entries     map[string][]nxpkgpath.AnchoredSystemPath
}

func (tc *testCache) Fetch(_ nxpkgpath.AbsoluteSystemPath, hash string, _ []string) (ItemStatus, []nxpkgpath.AnchoredSystemPath, error) {
...
func (tc *testCache) Put(_ nxpkgpath.AbsoluteSystemPath, hash string, _ int, files []nxpkgpath.AnchoredSystemPath) error {
	if tc.disabledErr != nil {
...
func (tc *testCache) Clean(_ nxpkgpath.AbsoluteSystemPath) {}
func (tc *testCache) CleanAll()                            {}
func (tc *testCache) Shutdown()                            {}

func newEnabledCache() *testCache {
	return &testCache{
		entries: make(map[string][]nxpkgpath.AnchoredSystemPath),
	}
}
...
func TestPutCachingDisabled(t *testing.T) {
	...
	err := mplex.Put("unused-target", "some-hash", 5, []nxpkgpath.AnchoredSystemPath{"a-file"})
	if err != nil {
