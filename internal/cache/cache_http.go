...
func (cache *httpCache) Put(anchor nxpkgpath.AbsoluteSystemPath, hash string, duration int, files []nxpkgpath.AnchoredSystemPath) error {
	// if cache.writable {
...
func (cache *httpCache) write(w io.WriteCloser, anchor nxpkgpath.AbsoluteSystemPath, files []nxpkgpath.AnchoredSystemPath, cacheErrorChan chan error) {
...
func (cache *httpCache) Fetch(_ nxpkgpath.AbsoluteSystemPath, key string, _ []string) (ItemStatus, []nxpkgpath.AnchoredSystemPath, error) {
	cache.requestLimiter.acquire()
	defer cache.requestLimiter.release()
...
func (cache *httpCache) retrieve(hash string) (bool, []nxpkgpath.AnchoredSystemPath, int, error) {
...
func restoreTar(root nxpkgpath.AbsoluteSystemPath, reader io.Reader) ([]nxpkgpath.AnchoredSystemPath, error) {
	cache := cacheitem.FromReader(reader, true)
	return cache.Restore(root)
}

func (cache *httpCache) Clean(_ nxpkgpath.AbsoluteSystemPath) {
...
func newHTTPCache(opts Opts, client client, recorder analytics.Recorder, repoRoot nxpkgpath.AbsoluteSystemPath) *httpCache {
	return &httpCache{
		writable:       true,
		client:         client,
