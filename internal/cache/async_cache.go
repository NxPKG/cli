...
type cacheRequest struct {
	anchor   nxpkgpath.AbsoluteSystemPath
	key      string
	duration int
...
func (c *asyncCache) Put(anchor nxpkgpath.AbsoluteSystemPath, key string, duration int, files []nxpkgpath.AnchoredSystemPath) error {
...
func (c *asyncCache) Fetch(anchor nxpkgpath.AbsoluteSystemPath, key string, files []string) (ItemStatus, []nxpkgpath.AnchoredSystemPath, error) {
...
func (c *asyncCache) Clean(anchor nxpkgpath.AbsoluteSystemPath) {
