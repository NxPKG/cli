...
func newGitSCM(repoRoot nxpkgpath.AbsoluteSystemPath) SCM {
...
func newFallback(repoRoot nxpkgpath.AbsoluteSystemPath) (SCM, error) {
...
func FromInRepo(repoRoot nxpkgpath.AbsoluteSystemPath) (SCM, error) {
...
func GetCurrentBranch(dir nxpkgpath.AbsoluteSystemPath) string {
...
func GetCurrentSha(dir nxpkgpath.AbsoluteSystemPath) string {
