...
func TestGetCurrentBranchMain(t *testing.T) {
	...
	// Setup git
	gitCommand(t, testDir, []string{"config", "--global", "user.email", "nxpkg@vercel.com"})
	gitCommand(t, testDir, []string{"config", "--global", "user.name", "Nxpkgbot"})
...
func gitRm(t *testing.T, dir nxpkgpath.AbsoluteSystemPath) {
...
func getOriginalConfig(cwd nxpkgpath.AbsoluteSystemPath) (string, string) {
...
func gitCommand(t *testing.T, cwd nxpkgpath.AbsoluteSystemPath, args []string) string {
...
func _gitCommand(cwd nxpkgpath.AbsoluteSystemPath, args []string) (string, error) {
