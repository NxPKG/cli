...
import (
	...
	nxpkgfs "github.com/nxpkg/cli/internal/fs"
...
func TestDeleteRepoRoot(t *testing.T) {
	...
	repoRoot := nxpkgfs.AbsoluteSystemPathFromUpstream(repoRootRaw)
...
func TestShutdown(t *testing.T) {
	...
	_, err = s.Shutdown(ctx, &nxpkgdprotocol.ShutdownRequest{})
